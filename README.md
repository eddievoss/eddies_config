...
- **Keyboard Centric** – Vim/Neovim keybindings everywhere for reduced mouse use.
- **Privacy Oriented** – Minimal telemetry, hardened browser configurations, and trusted open-source tools.  
- **Ergonomic** – **Colemak-DH** on an 36 key Corne Split keyboard to minimize strain. Years of alpine climbing and splitboarding have left me with wrist injuries, so longevity is a top priority.  
...
- **`Browser`** – Hardened configuration and extensions for privacy and productivity.  
